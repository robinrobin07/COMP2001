...
function error-message {
  ...
  echo "nooo! this is not the result you were looking for..." >&2
...
function error-exit {
  ...
  echo "nooo! this is not the result you were looking for... $?"
...
function displayhelp {
  echo "
sysconfig.sh: This script shows information about the system. 
It includes options, 
...
each option shows the information about the name it have
"
}
...
function cleanup {
  rm /tmp/*.$$ && echo "yesss! temporary files are cleared before exit"
  exit
}
